...
const UsyncBotProfileProtocol_1 = require('./Protocols/UsyncBotProfileProtocol.cjs');
const UsyncLIDProtocol_1 = require('./Protocols/UsyncLIDProtocol.cjs');
const Protocols_1 = require('./Protocols.cjs');
class USyncQuery {
    constructor() {
        this.protocols = [];
        this.users = [];
